class D {
  ...
  async import(n, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: p } = await import("./libredwg-web-BzW59HYS.mjs"), e = await p.create();
      ...
      const { default: v } = await import("./loader-fjhXoklS.mjs"), h = new v(g, this.output);

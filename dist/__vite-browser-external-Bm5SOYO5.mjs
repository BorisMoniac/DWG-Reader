class D {
  ...
  async import(u, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: c } = await import("./libredwg-web-Cm5zseth.mjs"), e = await c.create();
      ...
      const { default: g } = await import("./loader-BToef0i7.mjs"), f = new g(w, this.output);

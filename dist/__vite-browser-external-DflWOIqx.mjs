class D {
  ...
  async import(n, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: p } = await import("./libredwg-web-DTic3qS5.mjs"), e = await p.create();
      ...
      const { default: v } = await import("./loader-CoQWHAZf.mjs"), h = new v(g, this.output);

class D {
  ...
  async import(u, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: c } = await import("./libredwg-web-BmGF7X4I.mjs"), e = await c.create();
      ...
      const { default: g } = await import("./loader-Btvj0rdm.mjs"), f = new g(w, this.output);

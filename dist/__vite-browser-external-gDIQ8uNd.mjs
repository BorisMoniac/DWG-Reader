class D {
  ...
  async import(u, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: c } = await import("./libredwg-web-HlFXHYNK.mjs"), e = await c.create();
      ...
      const { default: g } = await import("./loader-DM95mPy5.mjs"), f = new g(w, this.output);

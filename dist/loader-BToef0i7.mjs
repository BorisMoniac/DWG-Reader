class T {
  ...
  transformEntityData(i, t, n, o, s, a, h, d, g) {
    const l = (r, c, u) => {
      const x = (r - n.x) * o, f = (c - n.y) * s, w = (u - n.z) * a;
      return {
        x: t.x + x * h - f * d,
        y: t.y + x * d + f * h,
        z: t.z + w
    ...
    switch (i.type) {
      ...
      case "LWPOLYLINE":
        return e.points && (e.points = e.points.map((r) => {
          ...
          var u, x;
          const c = l(r.x || ((u = r.point) == null ? void 0 : u.x) || 0, r.y || ((x = r.point) == null ? void 0 : x.y) || 0, 0);
      ...
      case "POLYLINE3D":
        return e.vertices && (e.vertices = e.vertices.map((r) => {
          var w, P, y;
          const c = ((w = r.point) == null ? void 0 : w.x) ?? r.x ?? 0, u = ((P = r.point) == null ? void 0 : P.y) ?? r.y ?? 0, x = ((y = r.point) == null ? void 0 : y.z) ?? r.z ?? 0, f = l(c, u, x);
          return { ...r, point: f, x: f.x, y: f.y, z: f.z };
        })), e;
      case "SPLINE":
  ...
  async addText(i, t, n) {
    var e, r;
    const o = t, s = o.startPoint || o.insertionPoint || o.position || { x: 0, y: 0, z: 0 }, a = o.text || o.textValue || o.content || "", h = o.textHeight || o.height || 2.5, d = ["rotation", "angle", "direction", "horizontalAlignment", "verticalAlignment", "halign", "valign", "alignment", "justify"], g = [];
    for (const c of d)
      if (o[c] !== void 0) {
        const u = o[c];
        g.push(`${c}=${typeof u == "object" ? JSON.stringify(u) : u}`);
      }
    this.output.info("TEXT fields: {0}", g.join(", ") || "none");
    let l = 0;
  ...
  async addMText(i, t, n) {
    ...
    const h = o.textHeight || o.height || 2.5, d = ["rotation", "angle", "direction", "attachment", "attachmentPoint", "drawingDirection", "flowDirection"], g = [];
    for (const c of d)
      if (o[c] !== void 0) {
        const u = o[c];
        g.push(`${c}=${typeof u == "object" ? JSON.stringify(u) : u}`);
      }
    this.output.info("MTEXT fields: {0}", g.join(", ") || "none");
    let l = 0;
...
`).replace(/\\/g, ""), !a.trim()) {
  ...
  async addTable(i, t, n) {
    ...
    const o = ((c = t.startPoint) == null ? void 0 : c.x) ?? 0, s = ((u = t.startPoint) == null ? void 0 : u.y) ?? 0, a = this.getZ((x = t.startPoint) == null ? void 0 : x.z);
    this.output.info(
    ...
    let h = s, d = 0, g = 0;
    for (let f = 0; f < t.rowCount && f < t.rowHeightArr.length; f++) {
      let w = o;
      const P = t.rowHeightArr[f] || 10;
    ...
    const l = t.columnWidthArr.reduce((f, w) => f + (w || 0), 0), e = t.rowHeightArr.reduce((f, w) => f + (w || 0), 0);
    if (l > 0 && e > 0) {
      const f = [
        [o, s, a],
        [o + l, s, a],

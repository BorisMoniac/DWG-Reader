class D {
  ...
  async import(u, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: c } = await import("./libredwg-web-COc1tvJ4.mjs"), e = await c.create();
      ...
      const { default: g } = await import("./loader-efPa5HW8.mjs"), f = new g(w, this.output);

class D {
  ...
  async import(n, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: p } = await import("./libredwg-web-L0TyM3gu.mjs"), e = await p.create();
      ...
      const { default: v } = await import("./loader-B_SeZzrR.mjs"), h = new v(g, this.output);

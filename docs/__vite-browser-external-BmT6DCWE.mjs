class g {
  ...
  async import(r, n) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: u } = await import("./libredwg-web-n60-DupV.mjs"), e = await u.create();
      ...
      const { default: w } = await import("./loader-CPKKMe9C.mjs"), d = new w(f, this.output);

class D {
  ...
  async import(n, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: p } = await import("./libredwg-web-DKrnt72I.mjs"), e = await p.create();
      ...
      const { default: v } = await import("./loader-Cq6YODY9.mjs"), h = new v(g, this.output);

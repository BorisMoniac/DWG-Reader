class D {
  ...
  async import(n, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: p } = await import("./libredwg-web-BN5juZbk.mjs"), e = await p.create();
      ...
      const { default: v } = await import("./loader-6KyVonaN.mjs"), h = new v(g, this.output);

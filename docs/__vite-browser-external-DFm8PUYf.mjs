class D {
  ...
  async import(n, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: p } = await import("./libredwg-web-DZVeaxRZ.mjs"), e = await p.create();
      ...
      const { default: v } = await import("./loader-js0EConJ.mjs"), h = new v(g, this.output);

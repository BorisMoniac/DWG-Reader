class D {
  ...
  async import(n, s) {
    ...
    try {
      ...
      const { Dwg_File_Type: t, LibreDwg: p } = await import("./libredwg-web-B87cQats.mjs"), e = await p.create();
      ...
      const { default: v } = await import("./loader-B5HpjDhc.mjs"), h = new v(g, this.output);

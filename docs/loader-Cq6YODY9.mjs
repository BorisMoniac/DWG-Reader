...
class b {
  ...
  explodeBlock(a) {
    ...
    const t = (l = (o = this.db.tables.BLOCK_RECORD) == null ? void 0 : o.entries) == null ? void 0 : l.find(
      (x) => x.name === a.name
    );
    if (!t || !t.entities || t.entities.length === 0)
      return [];
    const s = a.insertionPoint || { x: 0, y: 0, z: 0 }, i = t.basePoint || { x: 0, y: 0, z: 0 }, r = a.xScale || 1, n = a.yScale || 1, c = a.zScale || 1, h = (a.rotation || 0) * Math.PI / 180, P = Math.cos(h), d = Math.sin(h), e = [];
  ...
  transformEntityData(a, t, s, i, r, n, c, h, P) {
    const d = (o, l, x) => {
      const f = (o - s.x) * i, u = (l - s.y) * r, p = (x - s.z) * n;
      return {
        x: t.x + f * c - u * h,
        y: t.y + f * h + u * c,
        z: t.z + p
    ...
    switch (a.type) {
      ...
      case "TEXT":
      case "MTEXT": {
        const o = e.insertionPoint || e.position || { x: 0, y: 0, z: 0 }, l = d(o.x, o.y, o.z || 0);
        return e.insertionPoint = l, e.position = l, e.height && (e.height *= Math.abs(r)), e.textHeight && (e.textHeight *= Math.abs(r)), e;
      }
      case "LWPOLYLINE":
        return e.points && (e.points = e.points.map((o) => {
          const l = d(o.x, o.y, 0);
          return { ...o, x: l.x, y: l.y };
        })), e.vertices && (e.vertices = e.vertices.map((o) => {
          var x, f;
          const l = d(o.x || ((x = o.point) == null ? void 0 : x.x) || 0, o.y || ((f = o.point) == null ? void 0 : f.y) || 0, 0);
          return { ...o, x: l.x, y: l.y, point: l };
        })), e;
      case "POLYLINE2D":
      case "POLYLINE3D":
        return e.vertices && (e.vertices = e.vertices.map((o) => {
          var p, L, w;
          const l = ((p = o.point) == null ? void 0 : p.x) ?? o.x ?? 0, x = ((L = o.point) == null ? void 0 : L.y) ?? o.y ?? 0, f = ((w = o.point) == null ? void 0 : w.z) ?? o.z ?? 0, u = d(l, x, f);
      ...
      case "ATTDEF": {
        const o = e.insertionPoint || e.position || { x: 0, y: 0, z: 0 }, l = d(o.x, o.y, o.z || 0);
        return e.insertionPoint = l, e.position = l, e.height && (e.height *= Math.abs(r)), e.type = "TEXT", e;
      }
      default:
        return e;
    }
  ...
  async addLwPolyline(a, t, s) {
    ...
    const i = this.getZ(void 0), r = t.vertices.map((c) => [c.x, c.y, i]);
  ...
  async addPolyline2d(a, t, s) {
    if (!t.vertices || t.vertices.length < 2) return;
    const i = this.getZ(t.elevation), r = t.vertices.map((c) => [c.point.x, c.point.y, i]);
    await (await a.addPolyline3d({
      vertices: r,
      flags: (t.flag & 1) === 1 ? 1 : void 0
    })).setx("$layer", s);
  ...
  async addTable(a, t, s) {
    ...
    const i = ((l = t.startPoint) == null ? void 0 : l.x) ?? 0, r = ((x = t.startPoint) == null ? void 0 : x.y) ?? 0, n = this.getZ((f = t.startPoint) == null ? void 0 : f.z);
    this.output.info(
    ...
    for (let u = 0; u < t.rowCount && u < t.rowHeightArr.length; u++) {
      ...
      for (let w = 0; w < t.columnCount && w < t.columnWidthArr.length && !(h >= t.cells.length); w++) {
        const g = t.cells[h], E = t.columnWidthArr[w] || 50;
        if (g && g.text && g.text.trim()) {
          const y = g.textHeight || Math.min(L * 0.6, 2.5);
          await (await a.addText({
            position: [p + 2, c - L / 2, n],
            height: y,
            content: g.text.trim()
          })).setx("$layer", s), P++;
        }

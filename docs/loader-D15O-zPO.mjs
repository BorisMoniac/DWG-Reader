class d {
    ...
    try {
      switch (a.type) {
        ...
        case "MTEXT":
          ...
          break;
        case "POLYLINE2D":
          await this.addPolyline2d(e, a, t);
          break;
        case "POLYLINE3D":
          await this.addPolyline3d(e, a, t);
          break;
        case "SPLINE":
          await this.addSpline(e, a, t);
          break;
        default:
          break;
      }
  ...
  async addPolyline2d(e, a, t) {
    if (!a.vertices || a.vertices.length < 2) return;
    const s = a.elevation ?? 0, r = a.vertices.map((n) => [n.point.x, n.point.y, s]);
    await (await e.addPolyline3d({
      vertices: r,
      flags: (a.flag & 1) === 1 ? 1 : void 0
    })).setx("$layer", t);
  }
  async addPolyline3d(e, a, t) {
    if (!a.vertices || a.vertices.length < 2) return;
    const s = a.vertices.map((i) => [i.point.x, i.point.y, i.point.z ?? 0]);
    await (await e.addPolyline3d({
      vertices: s,
      flags: (a.flag & 1) === 1 ? 1 : void 0
    })).setx("$layer", t);
  }
  async addSpline(e, a, t) {
    var n;
    const s = ((n = a.fitPoints) == null ? void 0 : n.length) > 0 ? a.fitPoints : a.controlPoints;
    if (!s || s.length < 2) return;
    const r = s.map((o) => [o.x, o.y, o.z ?? 0]);
    await (await e.addPolyline3d({
      vertices: r
    })).setx("$layer", t);
  }
